...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210716_test_fdb6a281a4f8aa6e7318_20210716120704_archive.zip';
	const ARCHIVE_SIZE		 = '33646250';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fdb6a28-16120704';
    const SECONDARY_PACKAGE_HASH = '24ff7ba-16120704';
	const VERSION			 = '1.4.2';
